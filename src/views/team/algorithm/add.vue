    ...
    <div class="algorithmAdd">
        ...
        <div class="content">
            <div class="content_left">
                ...
                <Codemirror style="height: calc(100% - 30px);border: 1px solid #ccc;" v-model="addData.desc"
            ...
            <div class="content_right">
                ...
                <Codemirror style="height: calc(100% - 30px);border: 1px solid #ccc;" v-model="addData.detail"
                    placeholder="" :autofocus="true" :indent-with-tab="true" :tab-size="2" :extensions="extensions"
                    @ready="handleReady" />
            </div>
        </div>
...
import { algorithmAdd, type AlgorithmAddType } from "@/api/algorithm";
...
const view = ref(null);
const extensions = [];
const addData = reactive<AlgorithmAddType>({
    title: "",
    desc: "",
    detail: "",
});
...
async function add() {
    ...
    const res = await algorithmAdd(addData);
